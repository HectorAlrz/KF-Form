        ...
        <div class="pt-12 w-full md:w-4/12 px-4 text-center">
          <div class=" flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
            <div class="px-4 py-5 flex-auto">
              <div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-orange-kf">
                <i class="fas fa-address-card"></i>
              </div>
              <h6 class="text-xl font-semibold">Form with Formik & Yup</h6>
        ...
        <div class="pt-12 w-full md:w-4/12 px-4 text-center">
          <div class="flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
            <div class="px-4 py-5 flex-auto">
              ...
              <h6 class="text-xl font-semibold">React Hooks Form</h6>
              <p class="mt-2 mb-4 text-blueGray-500">
                Coming soon...
              </p>
